...
namespace Watermelon
{
    ...
    public class AudioController
    {
        ...
        public void Initialise(AudioSettings settings, GameObject targetGameObject)
        {
            ...
            soundVolume = PrefsSettings.GetFloat(PrefsSettings.Key.SoundVolume);
            musicVolume = PrefsSettings.GetFloat(PrefsSettings.Key.MusicVolumn);
        ...
        {
            return (!((PrefsSettings.GetFloat(PrefsSettings.Key.MusicVolumn) - 0.00005f) < 0));
        }
        ...
        public static void SetSoundsVolume(float newVolume)
        {
            ...
            AudioController.soundVolume = newVolume;
            PrefsSettings.SetFloat(PrefsSettings.Key.SoundVolume, newVolume);
        }
        ...
        public static void SetMusicVolume(float newVolume)
        {
            ...
            AudioController.musicVolume = newVolume;
            PrefsSettings.SetFloat(PrefsSettings.Key.MusicVolumn, newVolume);
        }
        ...
        public static void SetVolume(float volume)
        {
            ...
            PrefsSettings.SetFloat(PrefsSettings.Key.MusicVolumn, volume);
        ...
        public static void SetSourceDefaultSettings(AudioSource source, AudioType type = AudioType.Sound)
        {
            ...
            {
                volume = PrefsSettings.GetFloat(PrefsSettings.Key.MusicVolumn);
            }
            else if (type == AudioType.Sound)
            {
                volume = PrefsSettings.GetFloat(PrefsSettings.Key.SoundVolume);
            }
