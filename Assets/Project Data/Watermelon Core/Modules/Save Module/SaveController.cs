...
namespace Watermelon
{
    public static class SaveController
    {
        ...
        public static T FindSaveObject<T>(int hash) where T : class, ISaveObject
        {
            if (!isSaveLoaded)
            {
            ...
            return globalSave.FindSaveObject<T>(hash);
        }
        ...
        public static T FindSaveObject<T>(string uniqueName) where T :class, ISaveObject
        {
            return FindSaveObject<T>(uniqueName.GetHashCode());
        }
